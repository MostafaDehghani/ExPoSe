...
//                    continue;
//                if(s.getSpeakerAffiliation().equals("parl") || s.getSpeakerAffiliation().equals("gov"))
//                    continue;
                try{
...
//                bw.close();
    ...
    protected void analyzerMapInitializer(Map<String, Analyzer> analyzerMap) {
        ...
        analyzerMap.put("ROLES", new MyAnalyzer(false).MyNgramAnalyzer());
        analyzerMap.put("AFF", new MyAnalyzer(false).MyNgramAnalyzer());
        analyzerMap.put("FUNC", new MyAnalyzer(false).MyNgramAnalyzer());
    }
