 ...
 */
public class PositionsIndexer extends Indexer{

    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(PositionsIndexer.class.getName());
    public PositionsIndexer(String period, String position) throws Exception {
        super(period, position);
    }
    ...
    protected void docIndexer() throws Exception {
        try {
            for (Map.Entry<String, Speech> e : data.speeches.entrySet()) {
                String sAff = e.getValue().getSpeakerAffiliation();
                    if(sAff.equals("gov")|| sAff==null){
    ...
    public static void main(String[] args) throws Exception {
        PositionsIndexer si = new PositionsIndexer("20062010","m-g");
    }
}
